            ...
            <div className="flex flex-col">
                ...
                <div className="flex flex-row p-20">
                    <div className="flex align-start flex-col mx-5 w-80 mt-24">
                        ...
                        <div className="flex"> <p className="text-tintFont mt-5  text-xl">Transparency and Traceability </p></div>
                        <div className="flex"> <p className="text-tintFont mt-5 text-xl">Your Wellness Journey</p></div>
                    </div>
