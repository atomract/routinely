        ...
        <div className="flex mt-20 py-32">
            <div className="flex flex-col">
                ...
                <div className="flex flex-row p-20">
                    <div className="flex align-start flex-col mx-5 w-80 mt-24">
                        <div className="flex"> <p className="text-tintFont font-semibold text-2xl">Efficient and Holistic</p></div>
                        <button className="flex" onClick={() => setRotateState(true)}> <p className="text-tintFontLt mt-5  text-base">Transparency and Traceability </p></button>
                        <button className="flex" onClick={() => setRotateState1(true)}> <p className="text-tintFontLt mt-5 text-base">Your Wellness Journey</p></button>
                    </div>
                    <div className="flex align-middle mx-5">
                            <div className='z-10 absolute top-[199.52rem] left-[20rem]'>
                    ...
                    <div className="flex flex-col align-end ml-10 w-[30rem] mt-24">
