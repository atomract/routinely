...
const SliderSection = () => {
    ...
    return (
        <>
            <div className="e152 z-0 h-[880px] bg-contain shrink-0 w-[1280px]"  >
                <div className='py-64'>
                    <div className='flex flex-col'>
                                ...
                                images.map((e, k)=> {
                                    return (
                                        <div className='flex flex-col  px-7'>
                                            <div>
                                                <img className={`h-48 z-5 w-48 rounded-3xl ${k===idx ? "scale-150 ease-in duration-700" : null}`} src={e.path}/>
                                            </div>
                                        </div>
                                    )
                                })
                        ...
                        <div className='flex place-content-center py-6 flex-row'>
                            <button className='flex p-10' onClick={decIdx}>
                            ...
                            <div className='flex flex-col place-content-center'>
                                <p className='font-bold text-whiteFont self-center text-4xl'>{images[idx].head}</p>
                                <p className='font-normal text-whiteFont text-center w-[32rem] text-base'>{images[idx].about}</p>
                            </div>
                            <button className='flex p-10' onClick={incIdx}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44" fill="none">
